                    ...
                    <div class="col-md-6" style="padding:0px;">
											 <div class="col-md-12">
											   <div class="form-group">
												  <div class="col-md-12">
													   <input type="text" class="form-control" name="name" placeholder="Name" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->name; }else if(isset($r_name)){ echo $r_name; } ?>" required>
												  </div>
											   </div>
										   </div>
											 <div class="col-md-12">
		 										<div class="form-group">
		 											<div class="col-md-12">
		 												<input type="text" class="form-control" name="Mobile" placeholder="Mobile No" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->mobile_no; }else if(isset($r_mobile)){ echo $r_mobile; } ?>" required>
		 											</div>
		 										</div>
		 								 </div>
											 <div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="email" placeholder="Email Address" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->email_address; }else if(isset($r_email)){ echo $r_email; } ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<div class="col-md-12">
														<select class="form-control" name="role">
                                                            ...
                                                            <option value="delivery" <?php if(isset($selected_row[0])){ if($selected_row[0]->role == 'delievry'){ echo 'selected'; }} ?> >Delivery Person</option>
 											 ...
 											 <div class="form-group">
 												 <div class="col-md-12">
 													 <select class="form-control" name="user_status">
 														 <option value="active" <?php if(isset($selected_row[0])){ if($selected_row[0]->user_status == 'active'){ echo 'selected'; }} ?>  >Active</option>
                              <option value="inactive" <?php if(isset($selected_row[0])){ if($selected_row[0]->user_status == 'inactive'){ echo 'selected'; }} ?> >Inactive</option>
 		 											 </select>
 												 </div>
 											 </div>
 										</div>
											<div class="col-md-12">
		 									 <div class="form-group">
		 										 <div class="col-md-12">
		 											 <select class="form-control" name="outlet" required  <?php if($user_data[0]->role != 'master admin'){ echo 'disabled'; } ?> >
														 <option value="">Restorent</option>
														 <?php if(isset($outlet_list)){ foreach($outlet_list as $row){ ?>
														 <option value="<?php echo $row->outlet_id; ?>"  <?php if(isset($selected_row[0])){ if($selected_row[0]->outlet_id == $row->outlet_id){ echo 'selected'; }}else{ if($user_data[0]->outlet_id == $row->outlet_id ){ echo 'selected'; } } ?> ><?php echo $row->outlet_name; ?></option>
                             <?php }}  ?>
		 											 </select>
		 										 </div>
		 									 </div>
											...
											<div class="col-md-12">
		 									 <div class="form-group">
		 										 <div class="col-md-12">
		 											 <input type="text" class="form-control" name="user_id" placeholder="User Id" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->user_name; }else if(isset($r_user)){ echo $r_user; } ?>" required>
		 										 </div>
		 									 </div>
		 								  </div>
											<div class="col-md-12">
												<div class="form-group">
													<div class="col-md-12">
														<input type="text" class="form-control" name="user_password" placeholder="User Password" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->user_password; }else if(isset($r_password)){ echo $r_password; } ?>" required>
													</div>
												</div>
										 </div>
