                    ...
                    <div class="col-md-6" style="padding:0px;">
											 <div class="col-md-12">
											   <div class="form-group">
												  <div class="col-md-12">
													   <input type="text" class="form-control" name="name" placeholder="Name" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->name; } ?>" required>
												  </div>
											   </div>
										   </div>
											 <div class="col-md-12">
		 										<div class="form-group">
		 											<div class="col-md-12">
		 												<input type="text" class="form-control" name="Mobile" placeholder="Mobile No" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->mobile_no; } ?>" required>
		 											</div>
		 										</div>
		 								 </div>
											 <div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="email" placeholder="Email Address" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->email_address; } ?>" >
													 </div>
                                                     <span style="color:red; padding-left:25px;"><?php if(isset($msg)){ echo $msg; } ?></span>
												 </div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<div class="col-md-12">
														<select class="form-control" name="role">
 														  <option value="admin" <?php if(isset($selected_row[0])){ if($selected_row[0]->role == 'admin'){ echo 'selected'; }} ?> >Admin</option>
		 									 ...
		 									 <div class="form-group">
		 										 <div class="col-md-12">
		 											 <select class="form-control" name="outlet" required>
														 ...
														 <option value="<?php echo $row->outlet_id; ?>"  <?php if(isset($selected_row[0])){ if($selected_row[0]->outlet_id == $row->outlet_id){ echo 'selected'; }} ?> ><?php echo $row->outlet_name; ?></option>
                             <?php }}  ?>
		 											 </select>
		 										 </div>
		 									 </div>
											...
											<div class="col-md-12" style="display:none;">
		 									 <div class="form-group">
		 										 <div class="col-md-12">
		 											 <input type="text" class="form-control" name="user_id" placeholder="User Id" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->user_name; }else{ echo 'user'; } ?>" required>
		 										 </div>
		 									 </div>
		 								  </div>
											<div class="col-md-12">
												<div class="form-group">
													<div class="col-md-12">
														<input type="text" class="form-control" name="user_password" placeholder="User Password" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->user_password; } ?>" required>
													</div>
												</div>
										 </div>
									...
									<div class="col-md-6">
											<div class="form-group">
												<div class="col-md-12">
													<a href="<?php echo base_url(); ?>users/user_list">	<button type="button" class="btn-transparent btn-red"  style=" width:80px;">Cancel</button></a>
