                                         ...
                                         <div class="col-md-12">
											   <div class="form-group">
												  <div class="col-md-12">
                                                      ...
                                                      <select class="form-control" name="branch_root">
                                                          <option>Restorent</option>
                                                          
                                                          <?php if(isset($outlet_list_for_add_branch)){ foreach($outlet_list_for_add_branch as $row){ ?>
                                                          <option value="<?php echo $row->outlet_id; ?>" <?php if(isset($selected_row[0])){ if($selected_row[0]->branch_root == $row->outlet_id){ echo 'selected'; }  } ?> > <?php echo $row->outlet_name; ?></option>
                                                          <?php }} ?>
                                                      </select>
												  </div>
											   </div>
