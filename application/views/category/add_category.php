					...
					<section class="section_card floating_form">
						  <div class="panel-head" style="width:100%; height:30px; background-color:transparent; color:#dbd6d6; padding:10px 16px; ">
						      <h4 style="padding:0px; margin:0px; font-size:16px; text-transform:uppercase;">
										<i class="ion-android-radio-button-on" style="margin-right:10px;"></i>
										<?php if(isset($item_category_selected[0])){ echo 'Edit Category'; }else{ echo 'Add Category'; } ?>
									</h4>
						 </div>
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
									  ...
									  <div class="col-md-3" style="display:none;">
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="col-md-12">
													<input type="text" class="form-control" name="category_name" placeholder="Category Name" value="<?php if(isset($item_category_selected[0])){ echo $item_category_selected[0]->product_category_name; } ?>" required>
												</div>
											</div>
						       </div>
									 <div class="col-md-12">
										 <div class="form-group">
											 ...
											 <div class="col-md-12">
                                                  ...
                                                  <select class="form-control" name="have_subcategory" required <?php if(isset($item_category_selected[0])){ echo 'disabled'; } ?> >
                                                       <option value="">Have Sub Category</option>
                                                       <option value="yes"  <?php if(isset($item_category_selected[0])){ if($item_category_selected[0]->have_sub_category == 'yes'){ echo 'selected ';   } } ?> >Yes</option>
                                                       <option value="no"  <?php if(isset($item_category_selected[0])){ if($item_category_selected[0]->have_sub_category == 'no'){ echo 'selected ';   }} ?>>No</option>
                                                 </select>
                                                 
                                                 
                                                 <!--
												  <label style="color:#e8e8e8;">Have Sub Category</label> &nbsp
												  <label for="">yes</label>
													<input type="radio"  name="have_subcategory" value="yes" <?php if(isset($item_category_selected[0])){ if($item_category_selected[0]->have_sub_category == 'yes'){ echo 'checked ';   } echo 'disabled'; } ?>   required />

													<label for="">No</label>
													<input type="radio" name="have_subcategory" value="no"  <?php if(isset($item_category_selected[0])){ if($item_category_selected[0]->have_sub_category == 'no'){ echo 'checked ';   } echo 'disabled'; } ?>   required/>
                                                   -->
											 </div>
										 </div>
									</div>
											 ...
											 <div class="form-group">
												 <div class="col-md-12">
													<select class="form-control" name="status">
														<option value="active" <?php if(isset($item_category_selected[0])){ if($item_category_selected[0]->category_status == 'active'){ echo 'selected'; }} ?> >Active</option>
														<option value="inactive" <?php if(isset($item_category_selected[0])){ if($item_category_selected[0]->category_status == 'inactive'){ echo 'selected'; }} ?> >Inactive</option>
													</select>
												</div>
											</div>
						       </div>
									 <div class="col-md-12">
										  <div class="form-group">
											   <div class="col-md-12">
												 <input type="file" name="file" id="file" accept="image/*" value="" data-img_folder_name="product_category_image" style="display:none;"/>
												 <label for="file" id="img_label" style="width:150px; height:150px; border:1px solid #424351; text-align:center;  font-size:25px;"><?php if(isset($item_category_selected[0])){ ?> <img src="<?php echo base_url(); ?>uploads/product_category_image/<?php echo $item_category_selected[0]->category_image; ?>" data-img_name="" alt="" style="width:100% ; height:100%;"/><input type="hidden" name="image_name" value="<?php echo $item_category_selected[0]->category_image; ?>" /><button type="button" class="btn" id="temprory_remove_image" style="position:absolute; background-color:#ff4747; color:#ffffff; margin-top:-2px;">X</button>  <?php }else{ ?> <i class="fa fa-globe" style="margin-top:60px; margin-right:5px;"></i><span style="font-size:12px; ">Browse</span> <?php  } ?>  </label>
											   </div>
									...
									<div class="col-md-6">
											<div class="form-group">
												<div class="col-md-12">
												<a href="<?php echo base_url(); ?>category/add_category">	<button type="button" class="btn-transparent btn-red"  style=" width:100%;">Cancel</button></a>
												</div>
											</div>
						      </div>
									</form>
