                ...
                <div class="row">
                 ...
                 <div class="panel-body " style="padding-top:5px;">
                   ...
                   <div class="col-md-2" style="padding:6px;">
                     <div class="form-group">
                          <span class="search_input_i"><i class="fa fa-search"></i></span>
                          <input type="number" class="form-control" name="mobile_no" placeholder="Mobile No" value="<?php if(isset($return_mobile)){ echo $return_mobile; } ?>">
                     </div>
                   </div>
    ...
    <tr>
     ...
     <tbody id="customer_table">
                      ...
                      <tr>
                                       ...
                                       <td><?php echo date('H:i a',strtotime($row->time_stamp)); ?></td>   
                                       <td><?php echo $row->customer_name; ?></td> 
                                            
                                       <td><?php echo $row->contact_1; ?></td>
                                            
                                       <td><?php if($row->quality_rank == 5){ echo '<img src="'.base_url().'catalogs/assets/images/5star.png" style="height:15px;">'; }else if($row->quality_rank == 4){ echo '<img src="'.base_url().'catalogs/assets/images/4star.png" style="height:15px;">'; }else if($row->quality_rank == 3){ echo '<img src="'.base_url().'catalogs/assets/images/3star.png" style="height:15px;">'; }else if($row->quality_rank == 2){ echo '<img src="'.base_url().'catalogs/assets/images/2star.png" style="height:15px;">'; }else if($row->quality_rank == 1){ echo '<img src="'.base_url().'catalogs/assets/images/1star.png" style="height:15px;">'; } ?> </td>
                                       <td><?php if($row->service_rank == 5){ echo '<img src="'.base_url().'catalogs/assets/images/5star.png" style="height:15px;">'; }else if($row->service_rank == 4){ echo '<img src="'.base_url().'catalogs/assets/images/4star.png" style="height:15px;">'; }else if($row->service_rank == 3){ echo '<img src="'.base_url().'catalogs/assets/images/3star.png" style="height:15px;">'; }else if($row->service_rank == 2){ echo '<img src="'.base_url().'catalogs/assets/images/2star.png" style="height:15px;">'; }else if($row->service_rank == 1){ echo '<img src="'.base_url().'catalogs/assets/images/1star.png" style="height:15px;">'; } ?></td>
