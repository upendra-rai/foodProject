                                ...
                                <div class="input-group"  style=" width:100%;">
                                        ...
                                        <form action=""  method="post" >
                                           <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" >
                                               <?php if(isset($msg)){ if($msg = 'success'){  ?>
                                                <p style="width:100%; height:30px; color:#ffffff; background-color:#4caf50; padding: 3px 10px; text-align:center; box-shadow: 0px 3px 6px 0px rgba(0,0,0,0.6);" >
                                                    Message is successfuly sended.
                                               </p>
                                                <?php    }else{ ?>
                                                <p style="width:100%; height:30px; color:#ffffff; background-color:#fa0c23; padding: 3px 10px; text-align:center; " id="success_noti">
                                                   Process is failed!
                                               </p> 
                                               <?php }} ?>
                                               <!-- 
                                               <div class="form-group" id="data_5" style=" height:28px;">
                                                ...
                                                <div class="form-group" id="data_5" style=" height:28px;">
                                                    <select class="form-control" name="promo_code" required style="padding-left:5px;">
                                                        <option value="">Select Promo Code</option>
                                                        
                                                        <?php foreach($promo_list as $row){ ?>
                                                        <option value="<?php echo $row->promo_id; ?>"> Promo Code: <?php echo $row->promo_code; ?> /   <?php echo $row->promo_detail; ?></option>
                                                        <?php } ?>
                                                    </select>    
                                                </div>
                                           ...
                                           <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" >
                                                  ...
                                                  <div class="form-group" id="data_5" style=" height:28px;">
                                                      ...
                                                      <input type="submit"  name="submit_promo_code" class="btn" value="Send" style="background-color: #0088cc; border:1px solid #0088cc;  color:#ffffff; width: 100%;"/>
                                        ...
                                        <form action=""  method="post" id="myformsearch">
                                           <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" >   
                                             ...
                                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" >   
                                                <div class="form-group" id="data_5" style=" height:28px;">
                                                     <span class="search_input_i"><i class="fa fa-search"></i></span>
                                                   <input type="email" name="email_search" id="email_search" value="<?php if(isset($return_email)){ echo $return_email; } ?>" class="form-control" placeholder="Emaild Address" style="width:100%;">
                                                </div>
                                           </div>
