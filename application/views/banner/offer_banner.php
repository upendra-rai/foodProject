			  ...
			  <?php $this->load->view('common/sidemenu'); ?>
				...
				<section role="main" class="content-body" >
						...
						<section class="section_card" id="table_section">
                          ...
                          <tr>
														  <td><?php echo $i++; ?></td>
														  <td style="width:110px; padding:4px; text-align:center;"><img src="<?php echo base_url(); ?>uploads/offer_banner_image/<?php echo $row->img_name; ?>" style="border-radius:2px; border:1px solid #45496d;" width="100" ></td>
														  
														  <td style=" text-align:center;"><button class="btn btn-primary" id="edit_bt"  data-edit_id="<?php echo $row->offer_banner_id; ?>" style="color:#248afd; "><i class="fa fa-pencil"></i></button></td>
						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
									 ...
									 <div class="col-md-12">
										  <div class="form-group">
											   <div class="col-md-12">
												 <input type="file" name="file" id="file" accept="image/*" value="" data-img_folder_name="offer_banner_image" style="display:none;"/>
												 <label for="file" id="img_label" style="width:150px; height:150px; border:1px solid #424351; text-align:center;  font-size:25px;"><?php if(isset($selected_row[0])){ ?> <img src="<?php echo base_url(); ?>uploads/offer_banner_image/<?php echo $selected_row[0]->img_name; ?>" data-img_name="" alt="" style="width:100% ; height:100%;"/><input type="hidden" name="image_name" value="<?php echo $selected_row[0]->img_name; ?>" /><button type="button" class="btn" id="temprory_remove_image" style="position:absolute; background-color:#ff4747; color:#ffffff; margin-top:-2px;">X</button>  <?php }else{ ?> <i class="fa fa-globe" style="margin-top:60px; margin-right:5px;"></i><span style="font-size:12px; ">Browse</span> <?php  } ?>  </label>
											   </div>
												 <!-- last uploaded image name -->
											   <input type="hidden" name="last_uploaded_image_name" value="<?php if(isset($selected_row[0])){ echo $selected_row[0]->img_name; }?>">
										 </div>
									</div>
									<div class="col-md-6">
											<div class="form-group">
...
// rediren for update section
    $(document).on('click','button[id=edit_bt]',function(){
              ...
              var redirect_link  = '<?php echo base_url(); ?>offer_banner/edit/'+edit_id;
